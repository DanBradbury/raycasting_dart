...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  }, "call$1", "Element__determineMouseWheelEventType$closure", 2, 0, 6],
  ...
  DigitalInput: {
    ...
    DigitalInput$2: function(gameLoop, buttonIds) {
      ...
      for (t1 = new H.ListIterator(buttonIds, buttonIds.length, 0, null), t2 = this.buttons; t1.moveNext$0();) {
        buttonId = t1.__internal$_current;
...
["game_loop_html", "package:game_loop/game_loop_html.dart", , G, {
  ...
  GameLoopHtml: {
    ...
    _processKeyboardEvents$0: function() {
      ...
      if (t1)
        for (t1 = this._keyboardEvents, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
          keyboardEvent = t1.__internal$_current;
    ...
    _processMouseEvents$0: function() {
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      docElem.toString;
      canvasX = C.JSNumber_methods.toInt$0(Math.floor(t3 + t4 - C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(docElem.clientLeft))));
      t2 = t2.get$top(box);
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      canvasY = C.JSNumber_methods.toInt$0(Math.floor(t2 + t4 - C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(docElem.clientTop))));
      for (t2 = this._mouseEvents, t3 = new H.ListIterator(t2, t2.length, 0, null); t3.moveNext$0();) {
        mouseEvent = t3.__internal$_current;
        ...
        if (t5 === "mousemove") {
          ...
          if (mouseX < canvasX) {
            ...
            t5 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientLeft));
            t7 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientTop));
            t8 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientWidth));
            t9 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientHeight));
            if (t8 < 0)
              t8 = -t8 * 0;
            if (t9 < 0)
              t9 = -t9 * 0;
          ...
          if (t6 < canvasY) {
            ...
            if (t6 > canvasY + t9) {
              t5 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientLeft));
              t6 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientTop));
              t7 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientWidth));
              t8 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1.clientHeight));
              if (t7 < 0)
                t7 = -t7 * 0;
              clampY = t8 < 0 ? -t8 * 0 : t8;
    ...
    _processTouchEvents$0: function() {
      ...
      for (t1 = this._touchEvents, t2 = new H.ListIterator(t1, t1.length, 0, null); t2.moveNext$0();) {
        touchEvent = t2.__internal$_current;
  ...
  PointerLock: {
    ...
    }, "call$1", "get$_onClick", 2, 0, 22],
    _onPointerLockChange$1: [function($event) {
    }, "call$1", "get$_onPointerLockChange", 2, 0, 22],
  ...
  GameLoopTouchSet: {
    ...
    _addPosition$2: function(glTouch, touch) {
      var t1, t2, t3, t4;
      t1 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageY))), [null]);
      t2 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageY))), [null]);
      t3 = this.gameLoop;
      t4 = t3._gameTime;
      t3 = t3._frameCounter;
...
["", "hellodart.dart", , T, {
  ...
  main: [function() {
    ...
    t1[5] = 2;
    t1 = $.get$canvas();
    gameLoop = new G.GameLoopHtml(t1, 0, false, false, null, 0, false, 0, 0.03, 0, 0, 0, 0.05, true, null, null, null, null, H.setRuntimeTypeInfo(new P.Point(0, 0), [null]), null, null, H.setRuntimeTypeInfo([], [G._GameLoopTouchEvent]), H.setRuntimeTypeInfo([], [W.KeyboardEvent]), H.setRuntimeTypeInfo([], [W.MouseEvent]), null, null, null, null, null, null, null, null, 0.015, 0.03, H.setRuntimeTypeInfo([], [B.GameLoopTimer]), null, null);
    gameLoop.GameLoopHtml$1(t1);
    gameLoop.onUpdate = new T.main_closure();
    gameLoop.onRender = new T.main_closure0();
    if (!gameLoop._initialized) {
      t2 = C.EventStreamProvider_webkitfullscreenerror.forTarget$1(document);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_fullscreenError()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_webkitfullscreenchange.forTarget$1(document);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_fullscreenChange()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1.toString;
      t2 = C.EventStreamProvider_touchstart.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_touchStartEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchend.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_touchEndEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchcancel.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_touchEndEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_touchmove.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_touchMoveEvent()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_keydown.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_keyDown()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_keyup.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_keyUp()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = C.EventStreamProvider_resize.forTarget$1(window);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(gameLoop.get$_resize()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t2 = J.getInterceptor$x(t1);
      t3 = t2.get$onMouseMove(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(gameLoop.get$_mouseMove()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = t2.get$onMouseDown(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(gameLoop.get$_mouseDown()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t3 = t2.get$onMouseUp(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t3._target, t3._eventType, W._wrapZone(gameLoop.get$_mouseUp()), t3._useCapture), [H.getTypeArgumentByIndex(t3, 0)])._tryResume$0();
      t1 = t2.get$onMouseWheel(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(gameLoop.get$_mouseWheel()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      gameLoop._initialized = true;
    }
    gameLoop._interrupt = false;
    t1 = window;
    t2 = gameLoop.get$_requestAnimationFrame(gameLoop);
    C.Window_methods._ensureRequestAnimationFrame$0(t1);
    gameLoop._rafId = C.Window_methods._html$_requestAnimationFrame$1(t1, W._wrapZone(t2));
  ...
  Fov: function(x, y) {
    var ox, oy, wall_found, i, t1, t2;
    ox = $.mouse_x + 0.5;
    oy = $.mouse_y + 0.5;
    for (wall_found = false, i = 0; i < 10; ++i) {
      if (C.JSNumber_methods.toInt$0(Math.floor(ox)) >= 0)
        if (C.JSNumber_methods.toInt$0(Math.floor(oy)) >= 0)
          if (C.JSNumber_methods.toInt$0(Math.floor(ox)) < 25)
            if (C.JSNumber_methods.toInt$0(Math.floor(oy)) < 25) {
              t1 = $.get$map();
              t2 = C.JSNumber_methods.toInt$0(Math.floor(ox));
              t1 = t1.array;
              if (t2 < 0 || t2 >= t1.length)
                return H.ioore(t1, t2);
              t2 = t1[t2];
              t1 = C.JSNumber_methods.toInt$0(Math.floor(oy));
      ...
      if (t1)
        wall_found = true;
      if (!wall_found) {
        T.plot(C.JSNumber_methods.toInt$0(Math.floor(ox)), C.JSNumber_methods.toInt$0(Math.floor(oy)));
        ox += x;
        oy += y;
      }
    }
  ...
  drawMap: function(x, y) {
    var RED, GREEN, i, t1, t2, k, t3, t4;
    for (RED = null, GREEN = null, i = 0; i < 25; ++i)
      for (t1 = 32 * i, t2 = x === i, k = 0; k < 25; ++k) {
        t3 = $.get$map().array;
        if (i >= t3.length)
          return H.ioore(t3, i);
        t3 = t3[i];
        ...
        t3 = $.get$context();
        t3.beginPath();
        t3.fillStyle = "rgba(" + H.S(RED) + ", " + H.S(GREEN) + ", 0, 1)";
        t3.strokeStyle = "rgba(255, 255, 255, 1)";
        t4 = 32 * k;
        t3.fillRect(t1, t4, 32, 32);
        t3.strokeRect(t1, t4, 32, 32);
      }
  },
  Array2d: {
    ...
    set$height: function(_, v) {
      var x, t1, t2;
      for (; C.JSArray_methods.get$first(this.array).length > v;)
      ...
      for (t1 = this.defaultValue; C.JSArray_methods.get$first(this.array).length < v;)
  ...
  main_closure: {
    ...
    call$1: function(gameLoop) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new T.main__closure()), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
      t1 = t1.canvas;
      t1.toString;
      t1 = C.EventStreamProvider_click.forElement$1(t1);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.main__closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      for (i = 0; i <= 360; ++i) {
        dx = Math.cos(i);
        T.Fov(dx, Math.sin(i));
      }
  ...
  main__closure: {
    ...
    call$1: function(e) {
      ...
      if (typeof t2 !== "number")
        return t2.$div();
      $.mouse_x = C.JSNumber_methods.toInt$0(Math.floor(t2 / 32));
      t1 = t1.get$offset(e);
      t1 = t1.get$y(t1);
      if (typeof t1 !== "number")
        return t1.$div();
      t1 = C.JSNumber_methods.toInt$0(Math.floor(t1 / 32));
      $.mouse_y = t1;
      T.plot($.mouse_x, t1);
    },
    $isFunction: true
...
Isolate.$lazy($, "map", "map", "get$map", function() {
  var t1, t2;
  t1 = P.$int;
  t2 = H.setRuntimeTypeInfo(new T.Array2d(null, null), [t1]);
  t2.Array2d$3$defaultValue(25, 25, null, t1);
  return t2;
});
// Native classes
...
//# sourceMappingURL=hellodart.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function GameLoopHtml(element, _frameCounter, _initialized, _interrupt, _previousFrameTime, _frameTime, _resizePending, _nextResize, game_loop_html$GameLoopHtml$maxAccumulatedTime, _accumulatedTime, _gameTime, _renderInterpolationFactor, resizeLimit, processAllKeyboardEvents, _pointerLock, _keyboard, _mouse, _gamepad0, _lastMousePos, _touchSet, _rafId, _touchEvents, _keyboardEvents, _mouseEvents, onRender, onResize, onFullscreenChange, onPointerLockChange, onTouchStart, onTouchEnd, onKeyDown, _game_loop_html$_state, updateTimeStep, maxAccumulatedTime, _timers, onUpdate, _game_loop_common$_state) {
    ...
    this.game_loop_html$GameLoopHtml$maxAccumulatedTime = game_loop_html$GameLoopHtml$maxAccumulatedTime;
    ...
    this.processAllKeyboardEvents = processAllKeyboardEvents;
    ...
    this._game_loop_html$_state = _game_loop_html$_state;
    this.updateTimeStep = updateTimeStep;
    this.maxAccumulatedTime = maxAccumulatedTime;
    this._timers = _timers;
    this.onUpdate = onUpdate;
    this._game_loop_common$_state = _game_loop_common$_state;
  }
  ...
  function Array2d(array, defaultValue) {
    this.array = array;
